...
import { StyleSheet, View, Alert,Image,ImageBackground,Dimensions, TextInput, TouchableOpacity } from 'react-native';
import { Block,Text,theme } from 'galio-framework';
import Images from '../constants/Images';
const { height, width } = Dimensions.get('screen');
import Header from './header';

export default class ReceivePackage extends React.Component {
  constructor(props){
    super(props)
    this.state={
        fullName:'',
...
.then((responseJson) => {
   ...
   if(responseJson === 'Thank you for trusting us!..you will recieve a call from one of our agents in a moment.'){
    ...
    return (
      <View style={styles.screen}>
        ...
        <View style={styles.form}>
          <Text style={styles.formHeader}>Receiver's Info</Text>
          ...
          <TouchableOpacity style={styles.button} onPress={this.receiver}>
